...
export default class RewardsProgramState{
	...
	constructor(stakingState: {}, rewardsProgramIndex: number) {
		...
		const nonFormattedRewardsCoefficient = stakingState[STAKING_STRINGS.rewards_coefficient_prefix + this.rewardsProgramIndex.toString()] || 0
...
export class UserRewardsProgramState {
	...
	constructor(formattedUserLocalState: {}, rewardsProgramIndex: number, staking: Staking, userScaledTotalStaked: number) {
		...
		const nonFormattedRewardsCoefficient = formattedUserLocalState[STAKING_STRINGS.user_rewards_coefficient_prefix + this.rewardsProgramIndex.toString()] || 0
